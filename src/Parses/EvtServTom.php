...
class EvtServTom extends Parse {
    ...
    public function convert(){
        ...
        $this->obParsed->indobra = $this->ob[1][11];

        $this->obParsed->cnpjprestador = $this->ob[1][12];

        $this->obParsed->vlrtotalbruto = $this->ob[1][13];

        $this->obParsed->vlrtotalbaseret = $this->ob[1][14];

        $this->obParsed->vlrtotalretprinc = $this->ob[1][15];

        $this->obParsed->vlrtotalretadic = $this->ob[1][16];

        $this->obParsed->vlrtotalnretprinc = $this->ob[1][17];
        
        $this->obParsed->vlrtotalnretadic = $this->ob[1][18];

        $this->obParsed->indcprb = $this->ob[1][19];
